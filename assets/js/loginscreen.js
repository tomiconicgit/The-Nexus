...
function injectLoginCSS() {
  ...
  style.innerHTML = `
    ...
    #login-background::after {
      ...
      -webkit-mask-position: center top 50px;
      mask-position: center top 50px;
      
      /* Subtle fade for the bottom of the map */
      -webkit-mask-image: linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 50%), var(-webkit-mask-image);
      mask-image: linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 50%), var(mask-image);
