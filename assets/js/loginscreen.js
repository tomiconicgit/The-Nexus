...
function injectLoginCSS() {
  ...
  style.innerHTML = `
    ...
    #login-background{
      ...
      background-size: contain, cover, 100% 100vh, 100vw 100%;
      background-position: 50% 15%, center, center, center;
      background-repeat: no-repeat, no-repeat, repeat, repeat;
      animation: animateBackground 30s linear infinite alternate;
    }

    /* Animation for the background layers */
    @keyframes animateBackground {
      0% { background-position: 50% 15%; }
      100% { background-position: 50% 18%; }
    }
